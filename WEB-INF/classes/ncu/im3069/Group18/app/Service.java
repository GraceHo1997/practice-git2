...
public class Service {
    ...
    /**
     * 實例化（Instantiates）一個新的（new）Service 物件<br>
     ...
     * @param describe 產品敘述
     */
	public Service(String name, int price, String image, String describe, String address) {
		this.name = name;
		this.price = price;
		this.image = image;
	...
	public Service(int id, String name, int price, String image, String describe, String address) {
		this.id = id;
		this.name = name;
		this.price = price;
		this.image = image;
	...
	public Service(int id, String name, int price, String describe, String address) {
		this.id = id;
		this.name = name;
		this.price = price;
		this.image = image;
