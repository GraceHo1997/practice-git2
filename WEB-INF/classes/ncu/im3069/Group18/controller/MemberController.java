//doPost(mh.checkDuplicate)(mh.create)
//doGet(mh.getAll)(mh.getByID)
//doDelete(mh.deleteByID)
//doPut(m.update)
...
import ncu.im3069.Group18.app.MemberHelper;
...
public class MemberController extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        /** 建立一個新的會員物件 */
        Member m = new Member(email, password, name, phone, identity);
